...
public class GlobalRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> userNotFound(UserNotFoundException ex, WebRequest request){
        ApiErrorResponse apiResponse =new ApiErrorResponse
                                ...
                                .withDetail("Not able to find user record")
    ...
    public ResponseEntity<ApiErrorResponse> leaveNotFound(LeaveNotFoundException ex, WebRequest request){
        ApiErrorResponse apiResponse =new ApiErrorResponse
                                 .ApiErrorResponseBuilder()
                                .withDetail("Not able to find leave record")
                                .withMessage("Not a valid leave id.Please provide a valid leave id or contact system admin.")
                                .withError_code("404")
                                .withStatus(HttpStatus.NOT_FOUND)
                                .atTime(LocalDateTime.now(ZoneOffset.UTC))
                                .build();
